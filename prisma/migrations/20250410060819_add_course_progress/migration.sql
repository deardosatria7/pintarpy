/*
  ...
  - You are about to drop the `pg_produk` table. If the table is not empty, all the data it contains will be lost.

*/
-- CreateEnum
CREATE TYPE "CourseStatus" AS ENUM ('locked', 'in_progress', 'completed');

-- DropTable
DROP TABLE "pg_produk";
...
CREATE TABLE "UserCourseProgress" (
    ...
    "status" "CourseStatus" NOT NULL DEFAULT 'locked',
    "updatedAt" TIMESTAMP(3) NOT NULL,
